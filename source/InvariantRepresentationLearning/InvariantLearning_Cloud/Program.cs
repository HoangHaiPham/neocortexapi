...
namespace InvariantLearning_FrameCheck
{
    public class InvariantLearning
    {
        ...
        //private static string experimentFolder = $"Cloud_HtmInvariantLearning_{FRAME_WIDTH}x{FRAME_HEIGHT}_{NUM_IMAGES_PER_LABEL * 10}-{PER_TESTSET}%_Cycle{MAX_CYCLE}_{experimentTime}";
        ...
        //        Trace.WriteLine("=======================================");
        //        string predictedObj = cls.PredictObj_ForNormalImage(item.Value, 5);
        //        Trace.Flush();
        //        Trace.Close();
